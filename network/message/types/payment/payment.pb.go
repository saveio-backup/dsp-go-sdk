...
var fileDescriptor_6362648dfa63d410 = []byte{
	...
	,
}
...
func (m *Payment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BlockHash) > 0 {
		...
		i = encodeVarintPayment(dAtA, i, uint64(len(m.BlockHash)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.FileHash) > 0 {
		...
		i = encodeVarintPayment(dAtA, i, uint64(len(m.FileHash)))
		i--
		dAtA[i] = 0x3a
	}
	if m.Amount != 0 {
	...
	if m.UnitPrice != 0 {
		i = encodeVarintPayment(dAtA, i, uint64(m.UnitPrice))
		i--
		dAtA[i] = 0x28
	}
	if m.Asset != 0 {
		i = encodeVarintPayment(dAtA, i, uint64(m.Asset))
		i--
		dAtA[i] = 0x20
	}
	if m.PaymentId != 0 {
	...
	if len(m.Receiver) > 0 {
		...
		i = encodeVarintPayment(dAtA, i, uint64(len(m.Receiver)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Sender) > 0 {
		...
		i = encodeVarintPayment(dAtA, i, uint64(len(m.Sender)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Payment) Size() (n int) {
	...
	if m.Asset != 0 {
		n += 1 + sovPayment(uint64(m.Asset))
	}
	if m.UnitPrice != 0 {
		n += 1 + sovPayment(uint64(m.UnitPrice))
	}
	if m.Amount != 0 {
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PaymentId |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
